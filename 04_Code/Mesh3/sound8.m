...
[y0,Fs] =audioread('D:\drive_E_backup\Layla -Eric Clapton [Lyrics].wav');
...
folder = 'D:\mat\Project\Mesh';  % You specify this!
fullMatFileName = fullfile(folder,  'cDisplay_Layla8_R15-v2.mat');
...
%   cDisplay12AMPiso226=iso226sute6(song,y,cDisplay12AMP_19C,FreqIndex,Freq);
...
% 
%     close all;
    h3 = piperecord11(song,y0,cDisplay3AMP, cDisplay3PHAZ ,xDisplay,yDisplay,myjet,Freq, theta, Radius, cDisplay3AMP);
% close all
